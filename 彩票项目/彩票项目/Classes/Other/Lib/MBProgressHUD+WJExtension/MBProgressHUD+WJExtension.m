...
+ (void)wj_showMessage:(nullable NSString *)message hideAfterDelay:(NSTimeInterval)time toView:(nullable UIView *)view customView:(UIView *(^)(void))customView{

    [self wj_showCustomView:customView() message:message hideAfterDelay:time toView:view];
    
}

+ (void)wj_showHideAfterDelay:(NSTimeInterval)time customView:(UIView *(^)(void))customView {
